...
Project Goal is to facilitate the setup of an [Intl. CW Monitor Station](https://www.ncdxf.org/beacon/index.html) with modern data storage and analytics tools to study HF Propagation paths for Amateur Radio communication.
