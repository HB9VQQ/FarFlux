...
Project Goal is to facilitate the setup a global network of [Intl. CW Monitor Stations](https://www.ncdxf.org/beacon/index.html) with modern data storage and analytics tools to study HF Propagation paths for Amateur Radio communication.
