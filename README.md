...
Project Goal is to facilitate the setup of a global network of [Intl. CW Monitor Stations](https://www.ncdxf.org/beacon/index.html) based on modern data storage and analytics technology to study HF Propagation paths for Amateur Radio communication.
